    ...
    def _create_tool(self) -> Dict[str, Any]:
        ...
        return {
            "driver": {
                ...
                "shortDescription": {
                    "text": "AI code detection platform"
                },
                "fullDescription": {
        ...
        return [
            {
                ...
                "shortDescription": {
                    "text": "File shows substantial AI assistance"
                },
                "fullDescription": {
                ...
                "properties": {
                    "tags": ["ai-detection", "code-quality"],
                    "precision": "high"
                }
            },
            {
                ...
                "shortDescription": {
                    "text": "File shows partial AI assistance"
                },
                "fullDescription": {
            ...
            },
            {
                ...
                "shortDescription": {
                    "text": "File shows minimal AI assistance"
                },
                "fullDescription": {
    ...
    def _create_results(self, results: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if "pattern_results" in results and results["pattern_results"]:
            for file_result in results["pattern_results"]:
                sarif_result = self._create_file_result(
                    file_result,
                    results["repository"]
                )
                if sarif_result:
        ...
        if "ml_results" in results and results["ml_results"]:
            for file_result in results["ml_results"]:
                sarif_result = self._create_ml_file_result(
                    file_result,
                    results["repository"]
                )
                if sarif_result:
